...
function logError(error) {
    console.log(`%c⚡Error in @jweston/trigger: %c${error}`, `${errorStyling} border-left: 1px solid yellow; color: red; font-weight: bold`, `${errorStyling} color: white`);
}
function logWarning(error) {
    console.log(`%c⚡Warning in @jweston/trigger: %c${error}`, `${errorStyling} border-left: 1px solid yellow; color: yellow; font-weight: bold`, `${errorStyling} color: white`);
}
